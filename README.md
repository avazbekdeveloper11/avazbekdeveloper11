...
- 🎓 &nbsp; Flutter developer.
# Hi, I'm Avazbek Mavlonov 👋

**Senior Flutter Developer** from Tashkent, Uzbekistan — 4+ years of experience building and shipping cross-platform mobile applications.
...
- - 👨‍💼 Former **Mobile Team Lead** at a payments company — owned Flutter architecture and delivery end-to-end
  - - 💳 Built consumer **payment & money-transfer apps** (Xonsaroy Pay, Xonsaroy Money)
    - - 🧩 Author of open-source Dart packages: [chuck_interceptor](https://github.com/avazbekdeveloper11/chuck_interceptor) and [telegram_bot_crashlytics](https://github.com/avazbekdeveloper11/telegram_bot_crashlytics)
      ...
      - ## 🛠 Tech Stack
      -
      - - **Core:** Flutter, Dart, Kotlin / Java / Swift (native modules)
        - - **Architecture:** Clean Architecture, Domain-Driven Design, Bloc / Cubit
          - - **Data:** REST, WebSocket & STOMP, Firebase, Hive, Dio
            - - **Other:** Google Maps, Yandex Maps, Push Notifications, TDD, Git / GitLab CI
              -
              - ## 📫 Contact
              -
              - - Telegram: [@mavlonov_avazbek](https://t.me/mavlonov_avazbek)
                - - 📍 Tashkent, Uzbekistan — open to **remote** and onsite roles
                  - am a Certified Flutter Developer by Najot ta'im .<br/>
